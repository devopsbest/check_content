...
from new_content.getcontent import LevelActivityStructure, ActivityJsonStructure
from new_content.getcontent import media_url_list, THREAD_COUNT_FOR_CHECK_URL, check_resource, write_result_report, \
    fail_media_url_list, asr_error
from new_content.globals import *
